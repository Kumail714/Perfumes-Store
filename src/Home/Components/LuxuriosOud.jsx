  ...
  return (
    <div className='h-[500px] bg-[url(src/Home/Assets/bgImage1.png)] flex justify-between '>
     <div className=' relative flex items-center  '>
      <img className='h-72 px-14' src="src/ProductPage/Assets/Product1.png" alt="" />
      <img className='h-76 absolute right-42 top-40 ' src="src/ProductPage/Assets/Product2.png" alt="" />
      <img className='h-20 absolute bottom-8 left-28 ' src="src/ProductPage/Assets/Product44.png" alt="" />
      <img className='h-36 absolute bottom-4 right-16' src="src/ProductPage/Assets/Product3.png" alt="" />
     </div>
